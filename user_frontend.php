    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            /* Background global halaman */
            color: #333;
            min-height: 100vh;
            display: flex;
            flex-direction: column;
            align-items: center;
            /* Untuk mempusatkan main-wrapper */
        }
        ...
        .main-content-area-wrapper {
            ...
            border-radius: 20px;
            overflow: hidden;
            /* Penting untuk border-radius di elemen anak */
            box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15);
            /* Shadow untuk seluruh wrapper */
        ...
        .social-sidebar {
            ...
            /* Awalnya transparan, biar background muncul di .sidebar-bg */
            padding: 20px 0;
            /* Padding vertikal */
            display: flex;
            flex-direction: column;
            ...
            position: relative;
            /* Penting untuk background overlay */
            z-index: 1;
            /* Pastikan ikon di atas background overlay */
        }
        ...
        .social-sidebar .sidebar-bg {
            ...
            /* Warna latar belakang untuk bagian sosial media */
            z-index: -1;
            /* Di belakang ikon */
            border-top-left-radius: 20px;
            border-bottom-left-radius: 20px;
        ...
        .social-sidebar a {
            ...
            /* Shadow kecil di ikon */
        }

        .social-sidebar a:hover {
            transform: scale(1.15);
            /* Efek membesar lebih terasa */
            opacity: 0.9;
        ...
        .content-section {
            flex-grow: 1;
            /* Mengambil sisa ruang horizontal */
            display: flex;
            flex-direction: column;
            /* Konten di dalamnya ditumpuk vertikal */
        ...
        .grid {
            ...
            /* Menggunakan minmax untuk fleksibilitas */
            gap: 30px;
            margin-top: 40px;
            justify-content: center;
            /* Pusatkan grid jika ada sisa ruang */
            max-width: 1000px;
            /* Batasi lebar grid agar tidak terlalu melebar pada layar besar */
            margin-left: auto;
            margin-right: auto;
        }
        ...
        .card {
            ...
            border-radius: 20px;
            /* Sedikit kurangi border-radius */
        }

        .card img {
            width: 60px;
            /* Sedikit kurangi ukuran gambar */
            height: 60px;
            margin-bottom: 10px;
        ...
        .card h3 {
            font-size: 18px;
            /* Sedikit kurangi ukuran font judul */
            margin-bottom: 8px;
        }

        .card p {
            font-size: 14px;
            /* Sedikit kurangi ukuran font deskripsi */
        }
        ...
        @media (max-width: 992px) {
            .grid {
                ...
                /* Kembali ke 2 kolom atau lebih kecil jika perlu */
                gap: 20px;
            }
        }
        ...
        @media (max-width: 768px) {
            .grid {
                ...
                /* Bisa 2 kolom atau 1 kolom jika kartu tidak muat */
                gap: 15px;
            }
        }
        ...
        @media (max-width: 600px) {
            ...
            /* Tambahkan breakpoint ini untuk memastikan 1 kolom di HP kecil */
            .grid {
                grid-template-columns: 1fr;
                /* Paksa 1 kolom di layar yang sangat kecil */
                gap: 15px;
            }
        ...
        .card.kesekretariatan:hover {
            background: linear-gradient(135deg, #e8f5e9, #c8e6c9);
        }

        .card.kebendaharaan:hover {
        ...
        @media (max-width: 992px) {
            .navbar {
                ...
                min-height: unset;
                position: static;
                /* Navbar tidak sticky pada mobile */
                border-radius: 0;
            ...
            .main-content-area-wrapper {
                flex-direction: column;
                /* Ubah layout menjadi satu kolom */
                margin: 0;
                border-radius: 0;
                box-shadow: none;
            }
        ...
        <div class="content-section">
            ...
            <div class="container">
                ...
                <div class="grid" id="divisi-grid">
                    <div class="card kesekretariatan" onclick="window.location.href='user_proker.php?divisi=Kesekretariatan'">
                        <img src="https://static.vecteezy.com/system/resources/previews/001/486/411/original/open-book-icon-free-vector.jpg" alt="Kesekretariatan">
                        <h3>Divisi Kesekretariatan</h3>
                        <p>Klik untuk kelola program kerja</p>
                    </div>
                    <div class="card kebendaharaan" onclick="window.location.href='user_proker.php?divisi=Kebendaharaan'">
                        <img src="https://png.pngtree.com/png-clipart/20200225/original/pngtree-coin-money-icon-png-image_5278199.jpg" alt="Kebendaharaan">
                        <h3>Divisi Kebendaharaan</h3>
                        <p>Klik untuk kelola program kerja</p>
                    </div>
                    <div class="card humas" onclick="window.location.href='user_proker.php?divisi=Humas'">
                        <img src="https://png.pngtree.com/png-clipart/20220720/original/pngtree-cute-best-friend-muslimah-cartoon-png-image_8389455.png" alt="Humas">
                        <h3>Divisi Humas</h3>
                        <p>Klik untuk kelola program kerja</p>
                    </div>
                    <div class="card pelayanan" onclick="window.location.href='user_proker.php?divisi=Pelayanan Umat'">
                        <img src="https://png.pngtree.com/png-clipart/20230825/original/pngtree-cartoon-muslim-kid-greeting-salaam-picture-image_8654637.png" alt="Pelayanan Umat">
                        <h3>Divisi Pelayanan Umat</h3>
                        <p>Klik untuk kelola program kerja</p>
                    </div>
                    <div class="card tarbiyah" onclick="window.location.href='user_proker.php?divisi=Tarbiyah'">
                        <img src="https://cdn.pixabay.com/photo/2022/09/17/15/34/muslim-7461232_1280.png" alt="Tarbiyah">
                        <h3>Divisi Tarbiyah</h3>
                        <p>Klik untuk kelola program kerja</p>
                    </div>
                    <div class="card kemuslimahan" onclick="window.location.href='user_proker.php?divisi=Kemuslimahan'">
                        <img src="https://www.clipartmax.com/png/middle/216-2162062_chibi-clipart-muslimah-budak-perempuan-muslimah-kartun.png" alt="Kemuslimahan">
                        <h3>Divisi Kemuslimahan</h3>
                        <p>Klik untuk kelola program kerja</p>
                    </div>
                </div>
            </div>
