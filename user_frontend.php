...
.navbar .auth-links a {
    color: white;
    margin-left: 20px; /* Sesuaikan jarak antar item menu jika perlu */
    ...
    align-items: center; /* Untuk mensejajarkan ikon dan teks */
...
.navbar .auth-links a i {
    ...
    font-size: 1em; /* Ukuran ikon, disesuaikan agar proporsional dengan teks */
}
