    ...
    <style>
        ...
        * {
        ...
        .container {
            flex: 1;
            max-width: 900px;
            /* Diperkecil sedikit karena tidak ada foto samping */
            margin: 30px auto;
            padding: 40px;
            ...
            display: flex;
            /* Tambahkan ini agar konten di tengah */
        ...
        .profile-container-full {
            ...
            padding: 30px;
            width: 100%;
            /* Mengisi seluruh lebar container parent */
            text-align: left;
            /* Teks rata kiri di dalam container ini */
        }
        ...
        .profile-info-full h2 {
            ...
            text-align: center;
            /* Judul tetap di tengah untuk estetika */
        }
        ...
        .profile-info-full p {
            ...
            color: #444;
            display: flex;
            /* Gunakan flex untuk label dan span agar sejajar */
        ...
        .profile-info-full p strong {
            color: #1e3a8a;
            flex-shrink: 0;
            /* Mencegah label mengecil */
            width: 180px;
            /* Lebar label yang cukup */
            margin-right: 15px;
        ...
        .edit-button {
            ...
            transition: background 0.3s ease, transform 0.2s ease;
            display: block;
            /* Tombol jadi block element */
            margin-left: auto;
            /* Pusatkan tombol jika perlu */
            margin-right: auto;
            /* Pusatkan tombol jika perlu */
        }
        ...
        @media (max-width: 768px) {
            ...
            .profile-info-full p {
                font-size: 16px;
                flex-direction: column;
                /* Label dan nilai tumpuk di mobile */
                align-items: flex-start;
            }
